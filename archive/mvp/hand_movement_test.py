import os
# Force EGL rendering (headless GPU rendering) - MUST be set before importing mujoco
...
def main():
    ...
    for cycle in range(num_cycles):
        ...
        # --- ACTION 1: CLOSE HAND ---
        print(f"\n--- Cycle {cycle+1}/{num_cycles}: Sending CLOSE command ---")
        ...
        # --- ACTION 2: OPEN HAND ---
        print(f"\n--- Cycle {cycle+1}/{num_cycles}: Sending OPEN command ---")
