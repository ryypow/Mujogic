...
#---- need to update for different target positions
    ...
    def reset(self, seed=None, options=None):
        ...
        q_grasp_angles = np.array([1.2, 0.8, 1.2, 1.2, 0.8, 0.8, 0.8, 0.8, 1.3, 1.1, 1.3, 1.1, 1.0, 1.3, 1.0, 0.8])
    ...
    def step(self, action):
        ...
        self.sim.move_gripper_to_angles(target_angles, 0.02)  # Fixed: was 0.3 (too slow) #
